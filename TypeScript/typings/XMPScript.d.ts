// https://android.googlesource.com/platform/external/xmp_toolkit/+/jb-mr1-dev/XMPCore/src/com/adobe/xmp/options/PropertyOptions.java
declare const kXMP_DELETE_EXISTING: number;
